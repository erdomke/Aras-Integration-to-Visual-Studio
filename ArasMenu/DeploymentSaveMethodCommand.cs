//------------------------------------------------------------------------------
// <copyright file="DeploymentSaveMethodCommand.cs" company="Company">
...
namespace ArasMenu
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class DeploymentSaveMethodCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeploymentSaveMethodCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private DeploymentSaveMethodCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static DeploymentSaveMethodCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new DeploymentSaveMethodCommand(package);
        }
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            if(string.IsNullOrEmpty(serverName) || string.IsNullOrEmpty(databaseName) || string.IsNullOrEmpty(loginName) || string.IsNullOrEmpty(loginPassword))
            {
                util.showError("Deployment server and login information could not be found in the Innovator.config file.", "Missing Config Data");
                return;
            }
