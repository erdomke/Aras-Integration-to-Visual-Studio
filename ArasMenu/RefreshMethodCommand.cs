...
namespace ArasMenu
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class RefreshMethodCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RefreshMethodCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private RefreshMethodCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static RefreshMethodCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new RefreshMethodCommand(package);
        }
